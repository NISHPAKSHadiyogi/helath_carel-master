...
String endjob="0";
String id="";
class Shiftdetailclosed extends StatefulWidget {
  /*
  ...
  */
  ...
  Shiftdetailclosed({required this.jobid});
...
class _ShiftdetailacceptscreenState extends State<Shiftdetailclosed> {
  late Timer timer;
  var  _currentAddress;
